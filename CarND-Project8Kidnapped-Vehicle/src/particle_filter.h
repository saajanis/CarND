...
public:
	 ...
	 */
    std::vector<LandmarkObs> dataAssociation(
	...
	*/
    ...
    double getMultivariateProbability(const Eigen::VectorXd &x, const Eigen::VectorXd &meanVec, const Eigen::MatrixXd &covMat);
};
